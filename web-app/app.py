...
def baseball():
    ...
    plt.xlabel('Counts')
    plt.ylabel('Labels')
    plt.title('Baseball bat Statistics')
    plt.savefig('./static/images/baseball.png')
    plt.clf()
    return render_template('display.html',url='./static/images/baseball.png', name="Baseball Bat")
...
def eyeglasses():
    ...
    plt.clf()
    return render_template('display.html',url='./static/images/eyeglasses.png',name="Eyeglasses")
...
def grapes():
    ...
    plt.clf()
    return render_template('display.html',url='./static/images/grapes.png',name="Grapes")
...
def anvil():
    ...
    plt.clf()
    return render_template('display.html',url='./static/images/anvil.png',name="Anvil")
...
def laptop():
    ...
    plt.clf()
    return render_template('display.html',url='./static/images/laptop.png',name="Laptop")
...
def dumbbell():
    ...
    plt.clf()
    return render_template('display.html',url='./static/images/dumbbell.png',name="Dumbbell")
...
def sun():
    ...
    plt.clf()
    return render_template('display.html',url='./static/images/sun.png',name="Sun")
...
def book():
    ...
    plt.clf()
    return render_template('display.html',url='./static/images/book.png',name="Book")
...
def drums():
    ...
    plt.clf()
    return render_template('display.html',url='./static/images/drums.png',name="Drums")
...
def ladder():
    ...
    plt.clf()
    return render_template('display.html',url='./static/images/ladder.png',name="Ladder")
